...
colorByOptBars =  {"DISSENT":"#D64541","CONSENT":"#117733","ITEMSET":"#D64541","HMT":"#44AA99","DSC+CLOSED+UB1":"#88CCEE","DSC+CLOSED+UB2":"#44AA99","debunk":"#44AA99","dsc":"#D64541", "DSC+CLOSED" : "#CC6677", "UB1":"red","UB2":"magenta", "DSC":"#DDCC77", "DSC+RandomWalk":"#AA4499","DSC+SamplingPeers+RandomWalk":"#AA4499"}
colorByOptLines =  {"DISSENT":"#D64541","CONSENT":"#117733","ITEMSET":"#D64541","HMT":"#44AA99","DSC+CLOSED+UB1":"#88CCEE","DSC+CLOSED+UB2":"#44AA99","debunk":"#44AA99","dsc":"#D64541", "DSC+CLOSED" : "#CC6677", "UB1":"red","UB2":"magenta", "DSC":"#DDCC77", "DSC+RandomWalk":"#AA4499","DSC+SamplingPeers+RandomWalk":"#AA4499"}
		...
		if len(distinctVarVectorFixed)>0:
			if plot_bars : 
				...
				if CONFIGURATION=="Q5" or CONFIGURATION=="Q6":
					...
					plt.plot([], colorByOptBars[optName], label=LabelOptName,linewidth=3.)
