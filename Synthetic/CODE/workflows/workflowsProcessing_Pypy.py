...
from workflowsControls.iteratorsStage import workflowStage_simpleIterator, \
    workflowStage_iteratorsOnThemes_Depth, workflowStage_iteratorsOnNominal, \
    workflowStage_iteratorsOnNumerics, \
    ...
    workflowStage_iteratorsOnMultipeAttributes_subgroupBitwise_subgroups_tests
from workflowsControls.matcherStage import workflowStage_simpleMatch
from workflowsControls.syncersStage import workflowStage_simpleSyncer, \
    workflowStage_appenderSyncer, workflowStage_flatAppenderSyncer
...
MAP_POSSIBLE_STAGE_TYPES={
    ...
    'multiple_attributes_iterator_sgbitwise_subgroups_tests':workflowStage_iteratorsOnMultipeAttributes_subgroupBitwise_subgroups_tests,
...
ITERATORS_STAGES_ARRAY=[
    ...
    'multiple_attributes_iterator_sgbitwise_subgroups_tests'
