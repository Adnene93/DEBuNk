...
from DSC_Algorithm.DSC_Algo import DSC_Entry_Point,similarity_between_patterns_set,similarity_between_patterns_set_by_bitset,similarity_between_patterns_set_2,DSC_input_config,pattern_printer,DSC_input_config_alpha
import pickle
...
def main_1(debug):
	...
	if True:
		...
		returned = next(DSC_input_config_alpha(json_config,FIGURES_FOR_RESULTS,verbose=VERBOSE))
